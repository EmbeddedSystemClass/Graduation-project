...
#define ar_WM_fuwei (WM_USER + 0x00)//自定义消息-调试界面-复位
#define ar_WM_switchSpeed (WM_USER + 0x01)//自定义消息-调试界面-复位
#define ar_WM_zijian (WM_USER + 0x02)//自定义消息-调试界面-设备自检
#define ar_WM_message (WM_USER + 0x03)//自定义消息-生产界面-消息框
...
void WINDOW_Callback(WM_MESSAGE * pMsg);
  ...
  WM_HWIN Createar_putinNumber(void);		
